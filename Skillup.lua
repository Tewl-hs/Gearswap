...
user_settings = {
    user_spells = {
        ...
        Geomancy = T{'Indi-Voidance','Indi-Precision','Indi-Poison'},
        Enhancing = T{'Barfire','Baraero','Barstone'},
        Ninjutsu = T{},
        Singing = T{'Mage\'s Ballad','Mage\'s Ballad II','Mage\'s Ballad III'},
        Blue = T{'Magic Fruit', 'Animating Wail', 'Battery Charge', 'Winds of Promy.'},
        Summoning = T{'Ifrit','Titan','Leviathan','Garuda','Shiva','Ramuh'}},
